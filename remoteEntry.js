...
"./DrawingApp":()=>{
      ...
      return __federation_import('/agent-editor/assets/assets/__federation_expose_DrawingApp-eXb_yCjs.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
